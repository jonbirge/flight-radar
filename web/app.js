// app.js - Web version of Flight Radar
// Replaces Electron IPC with direct browser fetch() and localStorage

'use strict';

// ============================================================
// Section 1 — Settings (localStorage)
// ============================================================
...
// ============================================================
// Section 2 — OpenSky API (browser fetch)
// ============================================================
...
// ============================================================
// Section 3 — window.flightAPI shim
// ============================================================
...
window.flightAPI = {
  ...
  onOpenSettings: () => {},  // no-op — web version uses SETTINGS button
};

// ============================================================
// Section 4 — Renderer (from src/renderer.js)
// ============================================================
...
const RATE_LIMIT_MS = 10000; // must match STATES_MIN_INTERVAL
...
// SETTINGS button (web version — replaces Electron menu trigger)
