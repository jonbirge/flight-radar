...
let timelineStartMs = null;      // selected flight timeline start (departure)
let timelineEndMs = null;        // selected flight timeline end (arrival)
let timelineCurrentMs = null;    // current timeline cursor time
let timelineRoutePoints = null;  // route points with cumulative distance for interpolation
